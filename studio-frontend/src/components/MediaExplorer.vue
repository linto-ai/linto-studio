        ...
        <div class="media-explorer__content__right__header">
          <div class="media-explorer__content__right__header__cell">
            <div class="media-explorer__content__right__header__left">
              <div
                class="media-explorer__content__right__header__select-all"
            ...
            <div class="media-explorer__content__right__header__right"></div>
          </div>
        </div>
        <div class="media-explorer__content__right__body">
          <slot name="before" />
          <div v-if="medias.length === 0" class="media-explorer__content__right__body__empty">
            <slot name="empty" />
          </div>
          <MediaExplorerItem
      ...
      files.forEach((file, index) => {
        const simulateUpload = () => {
          if (this.uploadProgress[index].progress < 100) {
            ...
            this.uploadProgress.every((item) => item.progress === 100)
          ) {
            setTimeout(() => {
              this.isDraggingOver = false
              this.uploadProgress = []
...
.media-explorer__content__right__header__left
  .media-explorer__content__right__header__select-all.active {
...
.media-explorer__content__right__body__empty {
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
