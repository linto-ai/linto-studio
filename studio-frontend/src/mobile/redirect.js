...
// a login started from the mobile app through an OIDC provider sets the
// SSO-return cookie, so the callback lands on /m/ whatever the device.
export const redirectingToMobileApp = shouldRedirectToMobileApp({
  ...
  isPhone:
    ...
    }) || getCookie(MOBILE_SSO_RETURN_COOKIE) !== null,
