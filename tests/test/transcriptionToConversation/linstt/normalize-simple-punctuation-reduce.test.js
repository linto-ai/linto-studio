const debug = require('debug')('linto:tests:linstt:normalize-simple-punctuation-reduce')
...
describe('normalize conversation segment from a reduced linstt transcription punctuation rules', () => {
  ...
  it('segment with no filter and rules of simple punctuation', () => {
