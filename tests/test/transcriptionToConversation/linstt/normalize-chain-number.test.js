const debug = require('debug')('linto:tests:linstt:normalize-chain-number')

const { segmentNormalizeText } = require(`${process.cwd()}/components/WebServer/controllers/conversation/normalizeSegment`)

describe('normalize conversation segment from a linstt transcription for a chained number', () => {
  ...
  it('segment with no filter and rules of a chain number', () => {
