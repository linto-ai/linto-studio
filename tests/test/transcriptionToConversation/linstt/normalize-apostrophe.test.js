const debug = require('debug')('linto:tests:linstt:normalize-double-apostrophe')
...
describe('normalize conversation segment from a linstt transcription with an apostrophe rules', () => {
