// Ported from studio-frontend/src/tools/test/wordsDeltafromPlainDiff.js (ava).
// Tests the server port wordsDeltaFromPlainDiff against the same fixtures.
// generateID() returns "id" when process.env.TEST is set.
process.env.TEST = "true"

const {
  wordsDeltafromPlainDiff,
} = require(`${process.cwd()}/components/EditorHandler/words/wordsDeltaFromPlainDiff`)
const { diffArrays } = require("diff")
const SyllabicFR = require(`${process.cwd()}/components/EditorHandler/words/syllabic/syllabicFR`)

// Minimal ava-style assertion shim so test bodies stay verbatim.
const t = {
...
test("Change one word on middle", () => {
  const oldText = "Bonjour les amis"
...
test("Replace an empty word with a new one", () => {
...
test("Change one word on middle on a turn containing empty words", () => {
  const oldText = "Bonjour les amis"
  const newText = "Bonjour mes amis"
...
test("Delete one word on middle and add two", () => {
  const oldText = "Bonjour les amis"
...
test("Delete a word with one syllabs and replace with a word of two syllabs", () => {
  const oldText = "Bonjour les amis"
...
test("Delete two word on middle and add one", () => {
...
test("Delete two word on middle", () => {
  const oldText = "Bonjour à ses amis"
...
test("add one word on middle two time", () => {
  const oldText = "Bonjour à ses amis"
...
test("add multiple words, at start, middle and end", () => {
  const oldText = "Bonjour à ses amis"
...
test("expand word before deletion", () => {
...
test("expand word after deletion", () => {
...
test("expand word without deletion", () => {
...
test("Edit word with needed syllab and add a word", () => {
  const oldText = "Hey les amis"
...
test("Edit word with needed syllab by longer one", () => {
  const oldText = "Hey les amis"
...
test("Change one word on middle when there is empty words before", () => {
...
test("erase a three word syllab with one syllab needed by a two word syllab", () => {
...
test("Delete word preceded by words with needed syllabs", () => {
