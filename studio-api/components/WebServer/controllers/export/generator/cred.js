const debug = require('debug')(`linto:conversation-manager:components:WebServer:controllers:export:generator:cred`)
...
const generate = (data, query) => {
    data.documentTitle = 'texte pour le Compte rendu des commissions et des délégations  - '
