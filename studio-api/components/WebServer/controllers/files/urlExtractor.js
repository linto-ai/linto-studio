const debug = require('debug')('linto:components:WebServer:controller:file:urlExtractor')

const { spawn } = require("child_process")
const { v4: uuidv4 } = require('uuid')
const { getAudioFolder, getStorageFolder } = require(`${process.cwd()}/components/WebServer/controllers/files/store`)
