const debug = require('debug')(`linto:components:MongoMigration:controllers:version:1.5.0:conversation`)
...
module.exports = {
    async up(db) {
        ...
        conversations.forEach(async (conv) => {
            ...
            if (!conv.type) {
                await db.collection(collections_name).updateOne({ _id: conv._id },
