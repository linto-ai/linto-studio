...
```bash
# Required: Your LinTO Studio API token
export LINTO_AUTH_TOKEN="your-auth-token-here"

# Optional: Custom LinTO Studio API base URL (defaults to https://studio.linto.ai/cm-api)
export LINTO_BASE_URL="https://studio.linto.ai/cm-api"
```
...
Create a test file with your audio samples:
...
- Node.js fs/promises for file handling
