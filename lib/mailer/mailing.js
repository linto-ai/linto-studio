...
class Mailing {
    ...
    userMailNotificationProfile(user, Type) {
    ...
    */
    ...
    async conversationShared(user, origin, sharedByEmail, conversationId) {
        if (!this.userMailNotificationProfile(user, TYPE.SHARE_CONVERSATION)) return true
    ...
    async conversationRightUpdate(user, origin, sharedByEmail, conversationId) {
        if (!this.userMailNotificationProfile(user, TYPE.SHARE_CONVERSATION_RIGHT_UPDATE)) return true
    ...
    async conversationUnshare(user, origin, name) {
        if (!this.userMailNotificationProfile(user, TYPE.UNSHARE_CONVERSATION)) return true
    ...
    async organizationInvite(user, origin, sharedByEmail, orgaName, organizationId) {
        if (!this.userMailNotificationProfile(user, TYPE.INVITE_ORGANIZATION)) return true
    ...
    async organizationRightUpdate(user, origin, orgaName) {
        if (!this.userMailNotificationProfile(user, TYPE.UPDATE_ORGANIZATION_RIGHT)) return true
    ...
    async organizationDelete(user, origin, orgaName) {
        if (!this.userMailNotificationProfile(user, TYPE.DELETE_ORGANIZATION_RIGHT)) return true
