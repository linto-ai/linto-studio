...
function shareConversation(payload) {
  return `
  <p>Vous avez reçu une transcription de conversation sur la plateforme LinTO Studio de la part de <strong>${payload.sharedByEmail}</strong>.</p>
...
function verifyEmailAddress(payload) {
  return `
  <p>Vous avez récemment modifier votre adresse email sur la plateforme LinTO Studio</p>
