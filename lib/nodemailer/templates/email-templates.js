function htmlResetLinkTemplate(payload) {
  ...
  <body>
    <div id="mail-wrapper">
      ...
      <!-- END Header -->
      <!-- Body -->
      <p>Pour vous connecter à votre compte Conversation Manager, cliquez sur le lien suivant : ${payload.resetLink}</p>
      
      <p style="color: #ccc; font-style: italic;">Si vous n'avez pas fait de demande de mot de passe oublié, vous pouvez ignorer cet email</p>
      <p style="color: #ccc; font-style: italic;">Pour modifier votre mot de passe, connectez vous à votre compte : "Mon Compte" > "Modifier le mot de pase"</p>
      <!-- END Body -->
