  ...
  <body>
    <div id="mail-wrapper">
      ...
      <table id="mail-header" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
            <td colspan="2" class="mail-title">${payload.subject}</td>
          </tr>
        </tbody>
      </table>
      <!-- END Header -->
      <!-- Body -->
      <p>Vous venez de créer un compte sur ${payload.reqOrigin}. Pour valider votre adresse email, veuillez cliquer sur lien ci-dessous: </p>
      ...
      <p style="color: #777; font-style: italic;">Pour gérer les paramètre de votre compte, rendez-vous dans la rubrique "Mon compte"</p>
      <!-- END Body -->
...
function htmlShareConversationTemplate(payload) {
  ...
  <body>
    <div id="mail-wrapper">
      ...
      <!-- END Header -->
      <!-- Body -->
      <p>Une conversation vous a été partagé par ${payload.sharedBy} sur ${payload.reqOrigin}, cliquez sur le lien suivant pour y accéder : </p>
      ...
      <p style="color: #777; font-style: italic;">Si vous ne souhaitez plus recevoir les notifications de partage, connectez-vous à votre compte : "Mon compte" > décochez "Recevoir les notifications de partage"</p>
      <!-- END Body -->
      <table id="mail-footer" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
...
function htmlShareConversationExternalTemplate(payload) {
  ...
  <body>
    <div id="mail-wrapper">
      ...
      <!-- END Header -->
      <!-- Body -->
      <p>Une conversation vous a été partagé par ${payload.sharedBy} sur ${payload.reqOrigin}.
      Un compte vient d'être créé pour vous, cliquez sur le lien suivant pour vous connecter : </p>
 
      <div style="margin: 0 auto 20px auto; padding:20px; background-color: #fff; max-width: 960px; min-width: 320px;"><p style="margin:0;"><a href="${payload.reqOrigin}/magiclink-auth/${payload.magicId}" target="_blank">${payload.reqOrigin}/magiclink-auth/${payload.magicId}</a></p></div>

      <p style="color: #777; font-style: italic;">Un compte viens d'être créé pour vous sur ${payload.reqOrigin}, pensez à compléter vos informations" </p>
      <!-- END Body -->
      <table id="mail-footer" cellpadding="0" cellspacing="0" width="100%">
        <tbody>
          <tr>
