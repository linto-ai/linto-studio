...
export interface TranscriptionEditorOptions {
     ...
     */
    saveTurn?: (payload: TranscriptionEditorSavePayload) => Promise<{
        ok: boolean;
        reason?: string;
    }>;
    /**
    ...
    unlockTurn?: (payload: TranscriptionEditorLockPayload) => Promise<{
        ok: boolean;
    }>;
    /**
     ...
     */
    splitTurn?: (payload: TranscriptionEditorSplitPayload) => Promise<{
        ok: boolean;
        reason?: string;
    }>;
    /**
     ...
     */
    deleteTurn?: (payload: TranscriptionEditorLockPayload) => Promise<{
        ok: boolean;
        reason?: string;
    }>;
    /**
     ...
     */
    mergeTurns?: (payload: TranscriptionEditorMergePayload) => Promise<{
        ok: boolean;
        reason?: string;
    }>;
    updateTurnSpeaker?: (payload: TranscriptionEditorTurnSpeakerPayload) => Promise<{
        ok: boolean;
        reason?: string;
    }>;
    renameSpeaker?: (payload: TranscriptionEditorRenameSpeakerPayload) => Promise<{
        ok: boolean;
        reason?: string;
    }>;
    replaceSpeaker?: (payload: TranscriptionEditorReplaceSpeakerPayload) => Promise<{
        ok: boolean;
        reason?: string;
    }>;
    /**
